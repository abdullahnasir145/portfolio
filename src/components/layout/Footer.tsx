      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            ...
            <a
              href="https://github.com/abdullah-xelinq"
              target="_blank"
            ...
            {/* LinkedIn - Update with your vanity URL */}
            <a
              href="https://www.linkedin.com/in/abdullah-nasir-xee"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors"
            >
            ...
            {/* Twitter/X - Update or remove if not used */}
            <a
            ...
            {/* Email - Linked to your specific address */}
            <a
